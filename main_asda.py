...
class App(ctkinter.CTk):
    ...
    def start_process(self):
        ...
        refs_and_vouchers = [] # One we receive the details for the vouchers, the urls are no longer needed
        ...
        print("Done!")
        self.popup("Finished", "The task has completed. The output file is saved as 'result.xlsx' in the same folder as this program.")
        self.destroy()
